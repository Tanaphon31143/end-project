...
import { attendance, courses } from "@/data/student";
  ...
  return (
    <>
      <PageTitle
        ...
        description="ค้นหาและตรวจสอบข้อมูลการเข้าเรียนของคุณ"
        action={
      ...
      <section className="card filters">
        <div className="field">
          ...
          <input className="input" type="date" defaultValue="2026-09-01" />
        </div>
        <div className="field">
          <label>รายวิชา</label>
