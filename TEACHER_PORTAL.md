...
- `src/lib/auth.ts` และ `src/lib/api-auth.ts` — อ่าน session, บังคับ role teacher และ resolve teacher_id
...
- `prisma/schema.prisma` — โมเดล MySQL/TiDB, enum สถานะ, relation, unique constraint และ index ที่ใช้ในพอร์ทัล
